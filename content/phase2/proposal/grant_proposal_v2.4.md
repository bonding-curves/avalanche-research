...
> **Version note:** v2.4 updates v2.3 (February 4, 2026) to reflect the confirmed budget of $100,000 (reduced from $150,000) and a revised start date of April 15, 2026. All milestone scopes and deliverables are unchanged; budgets are scaled proportionally across milestones and functional categories. Timeline runs April 15 – October 14, 2026.
...
The six-month structure from v2.3 is preserved unchanged. Parallel work streams within each milestone—data ingestion running alongside model specification in M1, PSUU infrastructure starting early in M2—remain intact. Milestone gates require Avalanche team approval before proceeding.
